...
using ApiBienesRaices.Data;                          // Espacio de nombres del contexto de base de datos
using ApiBienesRaices.Repository.IRepository;        // Interfaces de repositorios
using ApiBienesRaices.Repository;                    // Implementaciones de repositorios
...
using System.Text;                                   // Para convertir texto a bytes (UTF8)

// Crea el "builder" que configura los servicios y el entorno de la aplicación
...
builder.Services.AddScoped<IRepositoryPropietarios, RepositoryPropietarios>();
builder.Services.AddScoped<IRepositoryInmuebles, RepositoryInmuebles>();
builder.Services.AddScoped<IRepositoryAlquiler, RepositoryAlquiler>();
